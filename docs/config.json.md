...
*it contains a lot of settings that tell how bmake should build the project.*
...
>tell bmake what languages bmake should use
>has an array value

compile_tags

>tell bmake what the compile tags should be
...
## extra_info
[main info](#main_info)\
you don't actually need to have config.json, much less all of the tags. most of it can be skipped and those that can't bmake will automatically choose a value for them\
